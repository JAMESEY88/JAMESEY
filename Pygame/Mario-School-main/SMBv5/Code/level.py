        ...
        for row_index, row in enumerate(layout):
            for col_index,val in enumerate(row):
                if val != '-1':
                    ...
                    if type == 'terrain':
                        terrain_tile_list = import_cut_graphics('C:/Users/61430/Desktop/ASSIGNMENT/Pygame/Mario-School-main/SMBv5/Graphics/terrain/terrain_tiles.png')
                        tile_surface = terrain_tile_list[int(val)]
                        sprite = StaticTile(tile_size,x,y,tile_surface)
                        
                    if type == 'blocks':
                        question_block_tile_list = import_cut_graphics('C:/Users/61430/Desktop/ASSIGNMENT/Pygame/Mario-School-main/SMBv5/Graphics/terrain/terrain_tiles.png')
                        tile_surface = question_block_tile_list[int(val)]
                        sprite = StaticTile(tile_size, x, y, tile_surface)
                        
                    if type == 'house':
                        house_tile_list = import_cut_graphics('C:/Users/61430/Desktop/ASSIGNMENT/Pygame/Mario-School-main/SMBv5/Graphics/house/House.png')
                        tile_surface = house_tile_list[int(val)]
                        sprite = StaticTile(tile_size,x,y,tile_surface)
                        
                    if type == 'background':
                        background_tile_list = import_cut_graphics('C:/Users/61430/Desktop/ASSIGNMENT/Pygame/Mario-School-main/SMBv5/Graphics/background/background.png')
                        tile_surface = background_tile_list[int(val)]
                        sprite = StaticTile(tile_size,x,y,tile_surface)
                        
                    if type == 'flag':
                        flag_tile_list = import_cut_graphics('C:/Users/61430/Desktop/ASSIGNMENT/Pygame/Mario-School-main/SMBv5/Graphics/flag/Flag.png')
                        tile_surface = flag_tile_list[int(val)]
                        sprite = StaticTile(tile_size,x,y,tile_surface)
                        
                    if type == 'flag_pole':
                        flag_pole_tile_list = import_cut_graphics('C:/Users/61430/Desktop/ASSIGNMENT/Pygame/Mario-School-main/SMBv5/Graphics/flag/flag.png')
    ...
    def player_setup(self,layout): # Player image
        for row_index, row in enumerate(layout):
            for col_index,val in enumerate(row):
                ...
                if val == '1':
                    spawn_surface = pygame.image.load('C:/Users/61430/Desktop/ASSIGNMENT/Pygame/Mario-School-main/SMBv5/Graphics/player/player.png').convert_alpha()
